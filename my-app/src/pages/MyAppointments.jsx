...
export default function ShowUserAppts(){
    ...
    const fetchAppts=(userData)=>{
        axios.get("https://bookish-spoon-json-server.bhishree18.repl.co/appointments").then((res)=>{
    ...
    const handleDelete=(id)=>{
        axios.delete(`https://bookish-spoon-json-server.bhishree18.repl.co/appointments/${id}`).then((res)=>{
