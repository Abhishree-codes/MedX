...
export default function ApptLanding(){
    return(
        ...
        >
            ...
            <Text color={"white"} fontSize={{"base":"s","sm":"2xl","md":"2xl"}} fontWeight={"semibold"}>Let's Make An Appointment !</Text>
            <Text color={"white"} fontSize={{"base":"s","sm":"2xl","md":"2xl"}} fontWeight={"semibold"}>Get Your Quote or Call: (+880) 123 456 789</Text>
            <Spacer/>
